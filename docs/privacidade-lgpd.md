...
Bybit segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Bybit** | AE | Crypto exchange API provider (provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [bybit@mcp.ai](mailto:bybit@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
